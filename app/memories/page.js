...
export const metadata = {
  title: 'Memories — Kent & Vale',
  description: 'Bespoke heirloom commissions that preserve what matters most. Wedding flowers, family keepsakes, memorial pieces, pet tributes, and more — handmade in Kent.',
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  name: 'Memories — Kent & Vale',
  description: 'Bespoke heirloom commissions incorporating personal artefacts, wedding flowers, memorial elements, and irreplaceable objects. Handmade in Kent, England.',
  provider: { '@type': 'LocalBusiness', name: 'Kent & Vale', url: 'https://kentandvale.com' },
  url: 'https://kentandvale.com/memories',
};
    ...
    <div style={{ background: 'white' }}>
      ...
      <section style={{
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: '680px' }}>
          ...
          <p style={{ fontFamily: 'var(--sans)', fontSize: '1.05rem', color: 'var(--stone)', lineHeight: 1.9, maxWidth: '520px', marginBottom: '3rem' }}>
            A Memories commission is not a product. It is an act of making permanent something that matters — a memory, a relationship, a person, a moment that will not come again. We work with you until the piece is exactly right.
          </p>
        ...
        <div style={{ maxWidth: '720px', margin: '0 auto' }}>
          ...
          <div style={{ fontFamily: 'var(--sans)', fontSize: '1rem', lineHeight: 1.9, color: '#444' }}>
            <p style={{ marginBottom: '1.5rem' }}>
              Every Memories commission begins not with a brief but with a conversation. We want to understand the thing you want to preserve — not just its dimensions, but its weight, its significance, its story.
            </p>
            <p style={{ marginBottom: '1.5rem' }}>
              We work across furniture and objects. A dining table becomes a Memories commission when wedding flowers are incorporated into the resin. A chess board when a grandfather's military insignia is set into the squares. A side table carries the memory of a beloved pet. A desk holds the wood from a tree that fell in a childhood garden.
            </p>
            <p>
              The form might be Studio. The game might be Games Room. But when something irreplaceable enters the piece — that is Memories.
            </p>
          </div>
        </div>
      </section>

      {/* Wedding Flower Preservation — featured panel */}
      <section style={{ padding: '0', background: 'white', overflow: 'hidden' }}>
        <div style={{
          display: 'grid',
          gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))',
          minHeight: '600px',
        }}>
          {/* Image side — three stacked thumbnails */}
          <div style={{
            display: 'grid',
            ...
            <div style={{ gridColumn: '1 / -1', overflow: 'hidden' }}>
              <img
                ...
                alt="Pink and purple wedding flowers preserved in a round clear resin coffee table"
            ...
            <div style={{ overflow: 'hidden' }}>
              <img
                ...
                alt="Deep red and white wedding flowers preserved in a round resin coffee table"
            ...
            <div style={{ overflow: 'hidden' }}>
              <img
                ...
                alt="Kent & Vale wedding flower resin pieces displayed at exhibition"
                style={{ width: '100%', height: '250px', objectFit: 'cover', display: 'block' }}
              />
            </div>
          </div>
          ...
          <div style={{
            ...
            <h2 style={{ fontFamily: 'var(--serif)', fontSize: 'clamp(1.8rem, 3.5vw, 2.8rem)', fontWeight: 400, color: 'var(--ivory)', lineHeight: 1.15, marginBottom: '2rem' }}>
              Your flowers.<br />Permanent.
            </h2>
            <p style={{ fontFamily: 'var(--sans)', fontSize: '1rem', color: 'var(--stone)', lineHeight: 1.9, marginBottom: '1.5rem' }}>
              Your wedding flowers last one day. We make them last forever. Set in hand-poured clear resin — as a coffee table, a side piece, a wall sculpture, or a jewel-like display block — your blooms are preserved exactly as they were on the day that changed everything.
            </p>
            <p style={{ fontFamily: 'var(--sans)', fontSize: '1rem', color: 'var(--stone)', lineHeight: 1.9, marginBottom: '3rem' }}>
              No two pieces are the same. Each one is designed around your flowers, your home, your story.
            </p>
            <Link
              href="/memories/wedding-flowers"
              style={{
      ...
      <section style={{ padding: '7rem 2rem', background: 'white' }}>
        <div style={{ maxWidth: '960px', margin: '0 auto' }}>
          ...
          <h2 style={{ fontFamily: 'var(--serif)', fontSize: 'clamp(1.4rem, 2.5vw, 2rem)', fontWeight: 400, textAlign: 'center', color: 'var(--charcoal)', marginBottom: '4rem' }}>
            Memories commissions in practice
          </h2>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '2rem' }}>
            {[
              { label: 'Wedding Flowers', title: 'The flowers from that day', desc: 'Your wedding bouquet, preserved and set in resin — as a coffee table, a display piece, or a sculpture that will outlast every photograph.' },
              ...
              { label: 'Pet', title: 'The one who filled the whole house', desc: 'A collar, a lead, a paw print, a lock of fur — held in resin and solid wood as a tribute worthy of a life that mattered.' },
              { label: 'Baby', title: 'The first years', desc: 'A lock of hair, a first shoe, a hospital tag — small things with enormous weight, turned into something permanent and beautiful.' },
              ...
              { label: 'Achievement', title: 'Something you earned', desc: 'A marathon medal. A degree certificate. A sporting honour. Set permanently in resin as an object of permanence rather than something kept in a drawer.' },
            ].map((ex, i) => (
      ...
      <section style={{ padding: '7rem 2rem', background: 'var(--charcoal)' }}>
        <div style={{ maxWidth: '680px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <p style={{ fontFamily: 'var(--sans)', fontSize: '0.95rem', color: 'var(--stone)', lineHeight: 1.9, marginBottom: '3rem' }}>
            Memories commissions are priced individually — there is no fixed tariff because no two pieces are the same. Our process page explains how a commission unfolds from the first call to final delivery. Our pricing page gives a guide to investment levels across the full range of what we make.
          </p>
      ...
      <section style={{ padding: '8rem 2rem', background: 'var(--ivory)' }}>
        <div style={{ maxWidth: '640px', margin: '0 auto' }}>
          ...
          <div style={{ fontFamily: 'var(--sans)', fontSize: '1rem', lineHeight: 1.9, color: '#444' }}>
            <p style={{ marginBottom: '1.5rem' }}>
              Every Memories commission begins with a phone call. Not a form — a conversation.
            </p>
            <p style={{ marginBottom: '1.5rem' }}>
